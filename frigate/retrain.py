...
import re
import requests
from frigate.const import RETRAIN_ENV_VAR, RETRAIN_API_HOST, DATABASE_HOST, DATABASE_TABLE, DATABASE_USER,DATABASE_PASSWORD
...
class RetrainApi:
    def __init__(self) -> None:
        self.host = RETRAIN_API_HOST
        self.key = None
        if RETRAIN_ENV_VAR in os.environ:
            self.key = os.environ.get(RETRAIN_ENV_VAR)
