...
export default function Events({ path, ...props }) {
  ...
  async function rejectEvent(event_id) {
    // // consolelog('Reject event id:', event_id);
    ...
    try {
      ...
      const response = await fetch('http://gotcha.bankey.co.za/api/reject', {
        method: 'POST',
        headers: {
  ...
  async function acceptEvent(event_id) {
    ...
    try {
      ...
      const response = await fetch('https://gotcha.bankey.co.za/api/accept', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  async function inspectEvent(event_id, checkbox_list) {
    ...
    try {
      ...
      const response = await fetch('https://gotcha.bankey.co.za/api/inspect', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
